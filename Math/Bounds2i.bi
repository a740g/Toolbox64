...
DECLARE LIBRARY "Bounds2i"
    ...
    SUB Bounds2i_SetRightTop (src AS Bounds2i, point AS Vector2i, dst AS Bounds2i)
    SUB Bounds2i_SetLeftBottom (src AS Bounds2i, point AS Vector2i, dst AS Bounds2i)
