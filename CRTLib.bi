...
$If CRTLIB_BI = UNDEFINED Then
    ...
    Declare CustomType Library
        ...
        Sub strncpy (ByVal dst As Offset, Byval src As Offset, Byval count As Unsigned Long)
        Sub strncpy_s (ByVal dst As Offset, Byval destsz As Unsigned Long, Byval src As Offset, Byval count As Unsigned Long)
        Function strlen~& (ByVal str As Offset)
        Function strnlen_s~& (ByVal str As Offset, Byval strsz As Unsigned Long)
        Function strncmp& (ByVal lhs As Offset, Byval rhs As Offset, Byval count As Unsigned Long)
