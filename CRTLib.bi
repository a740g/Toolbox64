...
$If CRTLIB_BI = UNDEFINED Then
    ...
    Declare CustomType Library
        ...
        Function StrLen~& Alias strlen (ByVal str As Unsigned Offset)
        Sub StrNCpy Alias strncpy (ByVal dst As Unsigned Offset, Byval src As Unsigned Offset, Byval count As Unsigned Offset)
        Function MemChr%& Alias memchr (ByVal ptr As Unsigned Offset, Byval ch As Long, Byval count As Unsigned Offset)
        Function MemCmp& Alias memcmp (ByVal lhs As Unsigned Offset, Byval rhs As Unsigned Offset, Byval count As Unsigned Offset)
        Sub MemSet Alias memset (ByVal dst As Unsigned Offset, Byval ch As Long, Byval count As Unsigned Offset)
        Sub MemCpy Alias memcpy (ByVal dst As Unsigned Offset, Byval src As Unsigned Offset, Byval count As Unsigned Offset)
        Sub MemMove Alias memmove (ByVal dst As Unsigned Offset, Byval src As Unsigned Offset, Byval count As Unsigned Offset)
        Sub MemCCpy Alias memccpy (ByVal dst As Unsigned Offset, Byval src As Unsigned Offset, Byval c As Long, Byval count As Unsigned Offset)
    ...
    Declare CustomType Library "CRTLib"
        $If 32BIT Then
            Function CLngPtr~& (ByVal p As Unsigned Offset)
        $Else
            Function CLngPtr~&& (ByVal p As Unsigned Offset)
        $End If
        Function PeekByteAtOffset~%% (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeByteAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Unsigned Byte)
        Function PeekIntegerAtOffset~% (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeIntegerAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Unsigned Integer)
        Function PeekLongAtOffset~& (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeLongAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Unsigned Long)
        Function PeekInteger64AtOffset~&& (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeInteger64AtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Unsigned Integer64)
        Function PeekSingleAtOffset! (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeSingleAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Single)
        Function PeekDoubleAtOffset# (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeDoubleAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Double)
        Function PeekOffsetAtOffset%& (ByVal p As Unsigned Offset, Byval o As Unsigned Offset)
        Sub PokeOffsetAtOffset (ByVal p As Unsigned Offset, Byval o As Unsigned Offset, Byval n As Unsigned Offset)
        Function PeekString~%% (s As String, Byval o As Unsigned Offset)
        Sub PokeString (s As String, Byval o As Unsigned Offset, Byval n As Unsigned Byte)
        Function RandomBetween& (ByVal lo As Long, Byval hi As Long)
        Function IsPowerOfTwo& (ByVal n As Unsigned Long)
        Function RoundUpToPowerOf2~& (ByVal n As Unsigned Long)
        Function RoundDownToPowerOf2~& (ByVal n As Unsigned Long)
