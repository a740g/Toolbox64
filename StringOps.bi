...
CONST STRING_BS = CHR$(8)
CONST STRING_HT = CHR$(9)
CONST STRING_LF = CHR$(10)
CONST STRING_VT = CHR$(11)
CONST STRING_FF = CHR$(12)
CONST STRING_CR = CHR$(13)
CONST STRING_ESC = CHR$(27)
CONST STRING_QUOTE = CHR$(34)
CONST STRING_CRLF = CHR$(13) + CHR$(10)
