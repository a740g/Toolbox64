...
const FOURCC FOURCC_FORM = MIDI_mmioFOURCC('F', 'O', 'R', 'M');
const FOURCC FOURCC_CAT  = MIDI_mmioFOURCC('C', 'A', 'T', ' ');
const FOURCC FOURCC_EVNT = MIDI_mmioFOURCC('E', 'V', 'N', 'T');

const FOURCC FOURCC_XDIR = MIDI_mmioFOURCC('X', 'D', 'I', 'R');
const FOURCC FOURCC_XMID = MIDI_mmioFOURCC('X', 'M', 'I', 'D');
