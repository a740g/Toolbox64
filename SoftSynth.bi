...
$IF SOFTSYNTH_BI = UNDEFINED THEN
    ...
    CONST SOFTSYNTH_VOICE_PLAY_REVERSE = 2 ' reverse playback
    CONST SOFTSYNTH_VOICE_PLAY_REVERSE_LOOP = 3 ' reverse loop
    CONST SOFTSYNTH_VOICE_PLAY_BIDIRECTIONAL_LOOP = 4 ' BIDI loop
