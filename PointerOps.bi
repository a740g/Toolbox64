...
$IF POINTEROPS_BI = UNDEFINED THEN
    ...
    DECLARE LIBRARY "PointerOps"
        ...
        SUB SetMemoryByte (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS _UNSIGNED _BYTE, BYVAL count AS _UNSIGNED _OFFSET)
        SUB SetMemoryInteger (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS INTEGER, BYVAL count AS _UNSIGNED _OFFSET)
        SUB SetMemoryLong (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS LONG, BYVAL count AS _UNSIGNED _OFFSET)
        SUB SetMemorySingle (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS SINGLE, BYVAL count AS _UNSIGNED _OFFSET)
        SUB SetMemoryInteger64 (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS _INTEGER64, BYVAL count AS _UNSIGNED _OFFSET)
        SUB SetMemoryDouble (BYVAL dst AS _UNSIGNED _OFFSET, BYVAL ch AS DOUBLE, BYVAL count AS _UNSIGNED _OFFSET)
