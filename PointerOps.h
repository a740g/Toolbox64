...
#define SetMemoryInteger(_dst_, _ch_, _cnt_) Pointer_SetMemory<int16_t>(reinterpret_cast<int16_t *>(_dst_), (_ch_), (_cnt_))
#define SetMemoryLong(_dst_, _ch_, _cnt_) Pointer_SetMemory<int32_t>(reinterpret_cast<int32_t *>(_dst_), (_ch_), (_cnt_))
#define SetMemorySingle(_dst_, _ch_, _cnt_) Pointer_SetMemory<float>(reinterpret_cast<float *>(_dst_), (_ch_), (_cnt_))
#define SetMemoryInteger64(_dst_, _ch_, _cnt_) Pointer_SetMemory<int64_t>(reinterpret_cast<int64_t *>(_dst_), (_ch_), (_cnt_))
#define SetMemoryDouble(_dst_, _ch_, _cnt_) Pointer_SetMemory<double>(reinterpret_cast<double *>(_dst_), (_ch_), (_cnt_))
