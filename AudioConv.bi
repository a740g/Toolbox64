...
DECLARE LIBRARY "AudioConv"
    ...
    SUB __AudioConv_ConvertADPCM4ToS8 (src AS STRING, BYVAL srcLen AS _UNSIGNED LONG, compTab AS STRING, dst AS STRING)
    SUB __AudioConv_ConvertDualMonoToStereoS8 ALIAS "__AudioConv_ConvertDualMonoToStereoInterleavedS8" (src AS STRING, BYVAL samples AS _UNSIGNED LONG, dst AS STRING)
    SUB __AudioConv_ConvertDualMonoToStereoS16 ALIAS "__AudioConv_ConvertDualMonoToStereoInterleavedS16" (src AS STRING, BYVAL samples AS _UNSIGNED LONG, dst AS STRING)
    SUB __AudioConv_ConvertDualMonoToStereoF32 ALIAS "__AudioConv_ConvertDualMonoToStereoInterleavedF32" (src AS STRING, BYVAL samples AS _UNSIGNED LONG, dst AS STRING)
