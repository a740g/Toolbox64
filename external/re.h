...
// a740g: Modified to work with QB64-PE
...
#define __RegExMatchCompiled(_p_, _t_, _i_, _l_) (re_matchp(reinterpret_cast<re_t>(_p_), (_t_) + (_i_) - 1, (_l_)))

/* Find matches of the txt pattern inside text (will compile automatically first). */
int re_match(const char *pattern, const char *text, int *matchlength);
#define __RegExMatch(_s_, _t_, _i_, _l_) (re_match((_s_), (_t_) + (_i_) - 1, (_l_)))
...
enum
{
    ...
    STAR,
    PLUS,
    RE_CHAR, // a740g: Changed this to RE_CHAR. CHAR clashes with stuff from Windows
    CHAR_CLASS,
    INV_CHAR_CLASS,
    DIGIT,
    NOT_DIGIT,
